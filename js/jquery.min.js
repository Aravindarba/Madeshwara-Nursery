...
whatsappMessage = encodeURIComponent(whatsappMessage); // URL encode the message
var whatsappUrl = `https://wa.me/EHQRHWFSLES4G1?autoload=1&text=${whatsappMessage}`;
